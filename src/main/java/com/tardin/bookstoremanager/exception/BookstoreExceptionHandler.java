package com.tardin.bookstoremanager.exception;
...
public class BookstoreExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        exception.getBindingResult().getFieldErrors()
                .forEach(fieldError -> errors.add(String.format(
                        "Field %s %s",
                        fieldError.getField().toUpperCase(),
                        fieldError.getDefaultMessage())));
        exception.getBindingResult().getGlobalErrors()
                .forEach(globalError -> errors.add(String.format(
                        "Object %s %s",
                        globalError.getObjectName().toUpperCase(),
